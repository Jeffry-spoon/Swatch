...
import com.jeffcode.swatch.activity.CategoryActivity
import com.jeffcode.swatch.databinding.LayoutCategoryItemBinding
import com.jeffcode.swatch.model.Category


class CategoryAdapter(var context : Context, val list : ArrayList<Category>) : RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder>() {
